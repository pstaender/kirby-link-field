...
},{}],"LinkSelect.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  watch: {
    ...
    value: function value(_value) {
      this.updating = true;
      Object.assign(this.data, _value);
...
exports.default = _default;
        var $9c701d = exports.default || module.exports;
      
      if (typeof $9c701d === 'function') {
        $9c701d = $9c701d.options;
      }
    
        /* template */
        Object.assign($9c701d, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _vm.showSelect
        ? _c(
            "k-column",
            { attrs: { width: _vm.uiWidth.select } },
            [
              _c("k-select-field", {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9c701d', $9c701d);
          } else {
            api.reload('$9c701d', $9c701d);
          }
        }
...
var _LinkSelect = _interopRequireDefault(require("./LinkSelect.vue"));
...
var _default2 = {
  components: {
    LinkSelect: _LinkSelect.default
  },
  props: {
    value: {
      type: Object,
  ...
  computed: {
    ...
    isMainScreen: function isMainScreen() {
  ...
  watch: {
    value: function value(_value) {
      this.data = Object.assign({}, _value);
    }
  }
};
exports.default = _default2;
        var $680675 = exports.default || module.exports;
      
      if (typeof $680675 === 'function') {
        $680675 = $680675.options;
      }
    
        /* template */
        Object.assign($680675, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$680675', $680675);
          } else {
            api.reload('$680675', $680675);
          }
        }
...
},{"./LinkSelect.vue":"LinkSelect.vue","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"Preview.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $c81671 = exports.default || module.exports;
      
      if (typeof $c81671 === 'function') {
        $c81671 = $c81671.options;
      }
    
        /* template */
        Object.assign($c81671, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.linkValue
    ? _c(
        "div",
        [
          _vm.isArray(_vm.linkValue)
            ? [
                _vm.linkType === "page"
                  ? _c(
                      "k-pages-field-preview",
                      _vm._b(
                        { attrs: { value: _vm.linkValue } },
                        "k-pages-field-preview",
                        _vm.$props,
                        false
                      )
            ...
            : _c(
                "p",
                { staticClass: "k-structure-table-text k-url-field-preview" },
                [
                  _vm.linkType === "url"
                    ? _c(
                        "a",
                        {
                          staticClass: "k-link",
                          attrs: { href: _vm.linkValue, target: "_blank" },
                          on: { click: _vm.handleClick }
                        },
                        [
                          _vm._v(
                            "\n      " +
                              _vm._s(_vm.value.text || _vm.linkValue) +
                              "\n    "
                          )
                        ]
                      )
                    : [
                        _vm.value.text
                          ? [
                              _c("strong", [_vm._v(_vm._s(_vm.value.text))]),
                              _vm._v(" " + _vm._s(_vm.linkValue) + "\n      ")
                            ]
                          : [
                              _vm._v(
                                "\n        " +
                                  _vm._s(_vm.linkValue) +
                                  "\n      "
                              )
                            ]
                      ]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c81671', $c81671);
          } else {
            api.reload('$c81671', $c81671);
          }
        }
...
panel.plugin('pstaender/uri-field', {
  ...
  components: {
    'k-link-field-preview': _Preview.default
  }
});
},{"./App.vue":"App.vue","./Preview.vue":"Preview.vue"}],"../../../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
